...
metadata:
  title: Hakkımızda
  description: >-
    Hukuk büromuzun mükemmeliyet, dürüstlük ve müvekkil odaklı hizmet taahhüdünü
    keşfedin. Deneyimli avukatlarımızı ve çeşitli çalışma alanlarımızı tanıyın.
hero:
  tagline: Hakkımızda
  ...
  subtitleHtml: >-
    ...
    etmeye kendini adamıştır. Samimi, ulaşılabilir bir yaklaşımı beklediğiniz
    titiz uzmanlıkla birleştiriyor, her cevabın anlaşılır ve uygulanabilir
    olmasını sağlıyoruz.<br /><br />Bireylerden startaplara ve köklü şirketlere
    kadar, hizmetlerimizi her hedefe özel uyarlıyoruz. İster bir yeniliği
    korumak, ister bir mülkü güvenceye almak, ister bir iş kurmak isteyin; size
    kişisel ilgi, saygı ve en iyi yolu bulmaya adanmış bir cozum ortagi
    sunuyoruz.
heroImage:
...
practiceAreas:
  ...
  subtitle: >-
    İhtiyacınıza özel uzman hukuki çözümler. Şirketler hukukundan göçmenliğe ve
    miras planlamasına kadar, avukatlarımız hak ve özgürlüklerinizi korumak için
    stratejik rehberlik ve kararlı savunuculuk sunar.
  items:
    - title: İş ve Şirketler Hukuku
      description: >-
        Her ölçekteki işletmeye, kuruluş ve sözleşmelerden birleşme, devralma ve
        uyuşmazlıklara kadar kapsamlı danışmanlık.
    ...
    - title: Dış Genel Hukuk Müşavirliği ve Danışmanlık
      description: >-
        Girişimlere ve büyüyen işletmelere sözleşmeler, uyum, risk yönetimi ve
        operasyonlarda sürekli hukuki danışmanlık sunar.
      icon: tabler:medical-cross
    - title: Gayrimenkul Hukuku
      description: >-
        Ticari ve konut işlemlerinde destek vererek her taşınmaz işleminin
...
values:
  title: Yaklaşımımız
  subtitle: >-
    Capitol Law Partners olarak, duyarlı, kişiselleştirilmiş ve güvene dayalı
    bir hukuk deneyimi sunmaktan gurur duyuyoruz. Her müvekkil, konu ne kadar
    karmaşık olursa olsun desteklenmiş ve güçlenmiş hisseder.
  items:
    - title: Müvekkil Odaklı Çözümler
      description: >-
        Hedefleriniz stratejimizi şekillendirir. Sizi dikkatle dinler, her planı
        özel durumunuza göre uyarlar ve en çok önem verdiğiniz şeylerle uyumlu
        pratik sonuçlar sunmaya odaklanırız.
    ...
    - title: Dürüstlük ve Kişisel Bağ
      description: >-
        Her dosyanın arkasında bir insan, bir işletme veya bir aile vardır.
        Dürüstlük, saygı ve hukuki meselenizi özen ve aciliyetle ele alma
        taahhüdüyle kalıcı ilişkiler kurarız.
locations:
  - title: Virginia Ofisi
    description: 13873 Park Center Road Suite, 152, Herndon, VA 20171
    image:
      src: ~/assets/images/map-herndon.jpg
      alt: Harita konum görseli
      href: >-
        https://www.google.com/maps/place/Capitol+Law+Partners/data=!4m2!3m1!1s0x0:0xdd25a8b02491aacd?sa=X&ved=1t:2428&ictx=111
  - title: Washington DC Ofisi
  ...
  - title: New York Ofisi
    description: 14 Wall Street 20. Kat, New York, NY 10005
    image:
...
contact:
  ...
  tagline: Bize ulaşın
  items:
    - title: Bizimle sohbet edin
      description: Hukuk ekibimizden hızlı yanıt ve kişiselleştirilmiş destek alın.
      link: https://wa.me/12024402272
      icon: tabler:messages
    - title: Bizi arayın
      description: >-
        Uzman avukatlarımızla doğrudan görüşerek hukuki danışmanlık ve destek
        alın. +1 (202) 440-2272
