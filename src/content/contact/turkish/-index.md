...
contactForm:
  ...
  subtitle: >-
    İhtiyaçlarınıza özel uzman hukuki rehberlik alın. Yolculuğunuza başlamak
  ...
  textarea: Mesaj
  disclaimer: >-
    Bu iletişim formunu göndererek kişisel bilgilerinizin toplanmasını kabul
    etmiş olursunuz.
...
features:
  ...
  items:
    - title: Genel destek
      description: >-
        Hukuki danışmanlık, dosya değerlendirmesi, sözleşme incelemesi, uyum
        süreçleri veya hizmetlerimizle ilgili genel sorularınız için bizimle
        sohbet edin.
    - title: Avukatla görüşün
      description: >-
        Doğrudan hukuki tavsiye mi istiyorsunuz? Kişiye özel danışmanlık ve
        profesyonel temsil için avukatlarımıza ulaşın.
    - title: Göçmenlik Dosyası Yardımı
      description: >-
        Göçmenlik dosyanızda yardıma mı ihtiyacınız var? Vize, yeşil kart,
        vatandaşlık başvuruları veya göçmenlik sorunlarınızda ekibimiz size
        rehberlik edecektir.
    - title: Telefon
...
metadata:
  title: İletişim | Capitol Law Partners
  description: >-
    Göçmenlik ve ticaret hukuku uzmanlarımızdan size özel hukuki danışmanlık
    alın. Kişisel danışmanlık için arayın, e-posta gönderin veya online
    formumuzu doldurun.
seo:
  title: İletişim | Capitol Law Partners
  description: >-
