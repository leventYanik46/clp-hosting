...
contactForm:
  ...
  subtitle: Obtenez un conseil juridique expert, adapté à vos besoins. Contactez-nous maintenant pour démarrer.
  inputs:
    name: Nom
    email: Email
    phone: Numéro de téléphone
  textarea: Message
  disclaimer: En soumettant ce formulaire, vous reconnaissez et acceptez la collecte de vos informations personnelles.
  description: Notre équipe répond généralement sous 24 heures ouvrées.
features:
  title: Nous sommes là pour vous aider !
  items:
  - title: Assistance générale
    description: Discutez avec nous pour des questions liées aux consultations juridiques, évaluations de dossier, revue de contrats, conformité ou toute question générale sur nos services.
  - title: Parlez à un avocat
    description: Besoin d’un conseil juridique direct ? Contactez nos avocats pour des consultations personnalisées et une représentation professionnelle.
  - title: Aide pour les dossiers d’immigration
    description: Besoin d’aide pour votre dossier d’immigration ? Visa, green card, naturalisation ou autres défis — notre équipe vous guide dans le processus.
  - title: Téléphone
...
metadata:
  title: contact
  description: Contactez nos experts en droit de l’immigration et des affaires pour des conseils sur mesure. Appelez, envoyez un e-mail ou remplissez notre formulaire en ligne pour une consultation personnalisée.
---
