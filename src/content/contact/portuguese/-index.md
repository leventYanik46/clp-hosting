...
contactForm:
  title: Envie uma mensagem hoje!
  subtitle: Receba orientação jurídica especializada sob medida para suas necessidades. Fale conosco agora para começar sua jornada!
  inputs:
    name: Nome
    email: Email
    phone: Telefone
  textarea: Mensagem
  disclaimer: Ao enviar este formulário, você reconhece e concorda com a coleta de suas informações pessoais.
  description: Nossa equipe geralmente responde em até 24 horas úteis.
features:
  title: Estamos aqui para ajudar!
  items:
  - title: Suporte geral
    description: Converse conosco sobre consultas jurídicas, avaliação de casos, revisão de contratos, questões de compliance ou dúvidas gerais sobre nossos serviços.
  - title: Fale com um advogado
    description: Precisa de orientação jurídica direta? Procure nossos advogados para consultas personalizadas e representação profissional.
  - title: Ajuda para casos de imigração
    description: Precisa de ajuda com seu caso de imigração? Seja para visto, green card, cidadania ou desafios migratórios, nossa equipe orienta todo o processo.
  - title: Telefone
...
locations:
  ...
  - title: Escritório em Minneapolis
...
metadata:
  title: contato
  description: Fale com nossos especialistas em direito de imigração e empresarial para receber orientação jurídica personalizada. Ligue, envie um e-mail ou preencha nosso formulário online para uma consulta sob medida.
---
