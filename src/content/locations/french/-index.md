...
callToAction:
  ...
  subtitle: >-
    Découvrez la différence que peut faire notre expertise dans vos questions
    juridiques. Contactez-nous dès aujourd’hui !
...
features:
  ...
  items:
    - title: Assistance générale
      description: >-
        Discutez avec nous pour toute question de consultation juridique,
        d’évaluation de dossier, de revue de contrats, de conformité ou pour
    ...
    - title: Aide pour les dossiers d’immigration
      description: >-
        Besoin d’aide pour votre dossier d’immigration ? Que ce soit pour un
        visa, une carte verte, la citoyenneté ou un autre défi, notre équipe
