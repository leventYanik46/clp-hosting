...
callToAction:
  ...
  subtitle: Découvrez la différence que peut faire notre expertise dans vos questions juridiques. Contactez-nous dès aujourd’hui !
  buttonText: Contactez-nous
features:
  title: Nous sommes là pour vous aider !
  items:
  - title: Assistance générale
    description: Discutez avec nous pour toute question de consultation juridique, d’évaluation de dossier, de revue de contrats, de conformité ou pour toute question générale sur nos services.
  ...
  - title: Aide pour les dossiers d’immigration
    description: Besoin d’aide pour votre dossier d’immigration ? Que ce soit pour un visa, une carte verte, la citoyenneté ou un autre défi, notre équipe vous guide dans le processus.
  - title: Téléphone
...
metadata:
  title: contact
  description: Trouvez nos bureaux en immigration, droit des affaires et marques près de chez vous. Consultez les adresses, horaires et itinéraire pour planifier un rendez-vous en personne.
---
