...
callToAction:
  ...
  subtitle: Descubra la diferencia que nuestra experiencia puede lograr en sus asuntos legales. ¡Contáctenos hoy!
  buttonText: Contáctenos
features:
  title: ¡Estamos aquí para ayudar!
  items:
  - title: Soporte general
    description: Hable con nosotros para consultas sobre asesorías legales, evaluaciones de casos, revisión de contratos, temas de cumplimiento o preguntas generales sobre nuestros servicios.
  ...
  - title: Asistencia para casos de inmigración
    description: ¿Necesita ayuda con su caso migratorio? Ya sea que solicite una visa, residencia, ciudadanía o enfrente desafíos de inmigración, nuestro equipo lo guía durante todo el proceso.
  - title: Teléfono
...
metadata:
  title: contacto
  description: Encuentre nuestras oficinas de derecho migratorio, comercial y de marcas cerca de usted. Revise direcciones, horarios e indicaciones para programar una consulta presencial.
---
