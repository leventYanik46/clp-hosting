---
metadata:
  title: Contencioso Migratório
  description: >-
    Litígios federais e administrativos para contestar negativas, atrasos e
    decisões migratórias desfavoráveis.
hero:
...
contactForm:
  ...
  infoTitle: Contencioso Migratório
  infoDescription: >-
    Litígios federais e administrativos para contestar negativas, atrasos e
    decisões migratórias desfavoráveis.
post:
  ...
  content: >
    ...
    <p>Litígios federais e administrativos para contestar negativas, atrasos e
    decisões migratórias desfavoráveis.</p>


    <h3>Principais Serviços</h3>

    <ul>
          <li>Ações de mandado de segurança para atrasos injustificados</li>
          <li>Contestações APA contra negativas e revogações</li>
          <li>Recursos e pedidos de reabertura/reconsideração</li>
          <li>Coordenação estratégica com petições e dispensas subjacentes</li>
        </ul>
