...
metadata:
  title: Curatela
  description: >-
    Administração financeira para quem não pode gerir seus bens, com relatórios
    transparentes e conformidade judicial.
hero:
...
post:
  ...
  content: >
    ...
    <p>Administração financeira para quem não pode gerir seus bens, com
    relatórios transparentes e conformidade judicial.</p>


    <h3>Principais Serviços</h3>

    <ul>
          <li>Petições de curatela e notificações obrigatórias</li>
          <li>Inventário, caução e prestações de contas contínuas</li>
          <li>Conformidade judicial e comunicação com partes interessadas</li>
          <li>Estratégias para equilibrar proteção, dignidade e independência</li>
        </ul>
