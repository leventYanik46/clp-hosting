...
metadata:
  ...
  description: >-
    Defesa incansável para vítimas de acidentes, desde a investigação até a
    negociação e o julgamento.
hero:
...
post:
  ...
  content: >
    ...
    <p>Defesa incansável para vítimas de acidentes, desde a investigação até a
    negociação e o julgamento.</p>
    ...
    <!-- seo-expanded -->
    <h3>Quando falar com um advogado de Acidentes de Carro, Caminhão e Motocicleta</h3>
    ...
    <!-- seo-topoff -->
    <h3>O que clientes costumam buscar na atuação em Acidentes de Carro, Caminhão e Motocicleta</h3>
...
seo:
  title: "Acidentes de Carro, Caminhão e Motocicleta | Servicos Juridicos da Capitol Law Partners"
  description: >-
    Defesa incansável para vítimas de acidentes, desde a investigação até a
    negociação e o julgamento.
  schema:
