...
metadata:
  ...
  description: >-
    Ações de responsabilidade por produtos que visam defeitos de projeto,
    fabricação ou advertência para buscar indenização por lesões.
hero:
...
post:
  ...
  content: >
    ...
    <p>Ações de responsabilidade por produtos que visam defeitos de projeto,
    fabricação ou advertência para buscar indenização por lesões.</p>
