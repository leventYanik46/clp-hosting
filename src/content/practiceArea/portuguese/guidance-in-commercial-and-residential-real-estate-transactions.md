...
metadata:
  ...
  description: >-
    Assessoria completa para compra, venda e financiamento de imóveis, mantendo
    negócios eficientes e em conformidade.
hero:
...
post:
  ...
  content: >
    ...
    <p>Assessoria completa para compra, venda e financiamento de imóveis,
    mantendo negócios eficientes e em conformidade.</p>
    ...
    <!-- seo-expanded -->
    <h3>Quando clientes procuram ajuda jurídica em Orientação em Transações Imobiliárias Comerciais e Residenciais</h3>
    ...
    <!-- seo-topoff -->
    <h3>O que clientes costumam buscar na atuação em Orientação em Transações Imobiliárias Comerciais e Residenciais</h3>
...
seo:
  title: "Orientação em Transações Imobiliárias Comerciais e Residenciais | Servicos Juridicos da Capitol Law Partners"
  description: >-
    Assessoria completa para compra, venda e financiamento de imóveis, mantendo
    negócios eficientes e em conformidade.
  schema:
