...
metadata:
  ...
  description: >-
    Défense acharnée des victimes d'accidents, de l'enquête à la négociation et
    au procès.
hero:
...
post:
  ...
  content: >
    ...
    <p>Défense acharnée des victimes d'accidents, de l'enquête à la négociation
    et au procès.</p>
    ...
    <!-- seo-expanded -->
    <h3>Quand consulter un avocat en Accidents de Voiture, Camion et Moto</h3>
...
seo:
  title: "Accidents de Voiture, Camion et Moto | Services Juridiques de Capitol Law Partners"
  description: >-
    Défense acharnée des victimes d'accidents, de l'enquête à la négociation et
    au procès.
  schema:
