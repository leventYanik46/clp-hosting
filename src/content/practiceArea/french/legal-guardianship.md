---
metadata:
  title: Tutelle Légale
  description: >-
    Solutions de tutelle qui protègent les mineurs ou les adultes vulnérables
    tout en respectant la dynamique familiale.
hero:
...
post:
  ...
  content: >
    ...
    <p>Solutions de tutelle qui protègent les mineurs ou les adultes vulnérables
    tout en respectant la dynamique familiale.</p>


    <h3>Services Clés</h3>

    <ul>
          <li>Pétitions, notifications et dépôts auprès du tribunal pour la tutelle</li>
          <li>Nomination d'une tutelle d'urgence ou temporaire</li>
          <li>Respect des obligations de rapport et des devoirs fiduciaires</li>
          <li>Conseils pratiques pour minimiser les tensions familiales</li>
        </ul>
