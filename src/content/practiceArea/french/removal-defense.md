...
contactForm:
  ...
  infoTitle: Défense contre l'Expulsion
  infoDescription: >-
    Défense complète pour les personnes en procédure d'expulsion, axée sur
    l'éligibilité aux recours et la constitution de preuves.
post:
  ...
  content: >
    ...
    <p>Défense complète pour les personnes en procédure d'expulsion, axée sur
    l'éligibilité aux recours et la constitution de preuves.</p>


    <h3>Services Clés</h3>

    <ul>
          <li>Audiences de caution et stratégie de garde</li>
          <li>Demandes d'asile, de maintien et de protection CAT</li>
          <li>Annulation d'expulsion et dérogations</li>
          <li>Appels devant le BIA et les juridictions fédérales</li>
        </ul>
