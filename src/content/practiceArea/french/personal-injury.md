...
post:
  ...
  content: >
    <ul>
      <li>
        <a href="/fr/practice-area/key-services/car-truck-and-motorcycle-accidents">
          Accidents de Voiture, Camion et Moto
        </a>
      </li>

      <li>
        <a href="/fr/practice-area/key-services/pedestrian-and-bicycle-accidents">
          Accidents Impliquant des Piétons et Cyclistes
        </a>
      </li>

      <li>
        <a href="/fr/practice-area/key-services/medical-negligence">
          Négligence Médicale
        </a>
      </li>

      <li>
        <a href="/fr/practice-area/key-services/dangerous-or-defective-products">
          Produits Dangereux ou Défectueux
        </a>
      </li>

      <li>
        <a href="/fr/practice-area/key-services/wrongful-death">
          Décès Injustifié
        </a>
      </li>
    </ul>
    ...
    <p>Si vous avez été blessé à cause de la négligence d’autrui, vous ne
    devriez pas affronter les compagnies d’assurance seul. Chez Capitol Law
    Partners, nous défendons les particuliers et les familles dans les moments
    les plus difficiles de leur vie.</p>
    ...
    prenons en charge la pression juridique et financière.</p>
