...
metadata:
  ...
  description: >-
    Holding providers accountable for preventable medical errors with meticulous
    case building.
hero:
  tagline: Contact Us
  title: Let's Connect!
...
post:
  ...
  content: >
    ...
    <p>Holding providers accountable for preventable medical errors with
    meticulous case building.</p>


    <h3>Key Services</h3>

    <ul>
          <li>Case screening with medical experts</li>
          <li>Standard of care analysis and causation proof</li>
          <li>Negotiation with carriers and hospital counsel</li>
          <li>Trial-ready preparation when settlement is insufficient</li>
        </ul>
