...
metadata:
  ...
  description: >-
    Comprehensive defense for individuals in removal proceedings, focused on
    relief eligibility and evidence.
hero:
  tagline: Contact Us
  title: Let's Connect!
  image:
...
post:
  ...
  content: >
    ...
    <p>Comprehensive defense for individuals in removal proceedings, focused on
    relief eligibility and evidence.</p>


    <h3>Key Services</h3>

    <ul>
          <li>Bond hearings and custody strategy</li>
          <li>Asylum, withholding, and CAT claims</li>
          <li>Cancellation of removal and waivers</li>
          <li>Appeals to the BIA and federal circuits</li>
        </ul>
