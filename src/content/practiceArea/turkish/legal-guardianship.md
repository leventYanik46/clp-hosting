...
metadata:
  title: Yasal Vesayet
  description: >-
    Aile dinamiklerine saygı göstererek küçükleri veya savunmasız yetişkinleri
    koruyan vesayet çözümleri.
hero:
  tagline: Bize Ulaşın
  title: Bağlanalım!
  image:
...
post:
  ...
  content: >
    ...
    <p>Aile dinamiklerine saygı göstererek küçükleri veya savunmasız
    yetişkinleri koruyan vesayet çözümleri.</p>


    <h3>Temel Hizmetler</h3>

    <ul>
          <li>Vesayet için dilekçeler, bildirimler ve mahkeme başvuruları</li>
          <li>Acil ve geçici vesayet atamaları</li>
          <li>Raporlama ve vekil sorumluluklarına uyum</li>
          <li>Aile içi sürtüşmeyi en aza indirmek için pratik rehberlik</li>
        </ul>
