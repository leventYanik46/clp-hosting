...
metadata:
  title: Tıbbi İhmal
  description: >-
    Önlenebilir tıbbi hatalar için sağlayıcıları titiz dosya hazırlığıyla
    sorumlu tutmak.
hero:
  tagline: Bize Ulaşın
  title: Bağlanalım!
...
post:
  ...
  content: >
    ...
    <p>Önlenebilir tıbbi hatalar için sağlayıcıları titiz dosya hazırlığıyla
    sorumlu tutmak.</p>
    ...
    <ul>
          <li>Tıbbi uzmanlarla dosya taraması</li>
          <li>Bakım standardı analizi ve nedensellik kanıtı</li>
          <li>Sigorta şirketleri ve hastane avukatlarıyla müzakere</li>
          <li>Uzlaşma yetersizse dava için hazırlık</li>
        </ul>
