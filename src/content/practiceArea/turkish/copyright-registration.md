---
metadata:
  title: Telif Hakkı Tescili
  description: >-
    Yaratıcı eserleri tescil ederek sahipliği güvence altına alın, ihlali
    önleyin ve uygulama seçeneklerini en üst düzeye çıkarın.
hero:
  tagline: Bize Ulaşın
  title: Bağlanalım!
  image:
...
post:
  ...
  content: >
    ...
    <p>Yaratıcı eserleri tescil ederek sahipliği güvence altına alın, ihlali
    önleyin ve uygulama seçeneklerini en üst düzeye çıkarın.</p>


    <h3>Temel Hizmetler</h3>

    <ul>
          <li>Yazılım, içerik, medya ve tasarımlar için tescil işlemleri</li>
          <li>İş için yapılan ve devir belgeleri</li>
          <li>Depozito kopyaları, zamanlama ve yayın stratejisi</li>
          <li>Adil kullanım, lisanslama ve izinler konusunda rehberlik</li>
        </ul>
