...
metadata:
  ...
  description: >-
    Sürekli takdir ve ulusal/uluslararası tanınırlığa dayalı olağanüstü yetenek
    yeşil kart dilekçeleri.
hero:
  tagline: Bize Ulaşın
  title: Bağlanalım!
  image:
...
contactForm:
  ...
  infoDescription: >-
    EB-1A Yeşil Kart uygunluğu, dilekçe taslağı, kanıt ve mülakat hazırlığı için
    uçtan uca destek.
  googleReview:
...
post:
  ...
  content: >
    ...
    <p>EB-1A Yeşil Kart hizmetlerimiz, uygunluk, dilekçe stratejisi ve kanıt
    ...
    <h3>Uygunluk ve Strateji</h3> <p>Arka planınızı EB-1A Yeşil Kart
    ...
    <h3>Neden Bizimle Çalışmalısınız?</h3> <p>Odaklı ve stratejik temsil; EB-1A
