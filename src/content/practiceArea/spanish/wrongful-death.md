...
metadata:
  ...
  description: >-
    Representación compasiva para familias que buscan responsabilidad y
    estabilidad financiera tras una pérdida.
hero:
  tagline: Contáctenos
  title: ¡Conectemos!
  image:
...
post:
  ...
  content: >
    ...
    <p>Representación compasiva para familias que buscan responsabilidad y
    estabilidad financiera tras una pérdida.</p>


    <h3>Servicios Clave</h3>

    <ul>
          <li>Investigación de negligencia y causalidad</li>
          <li>Desarrollo de daños económicos y no económicos</li>
          <li>Coordinación con asuntos de sucesión/herencia</li>
          <li>Litigio y negociación guiados por los objetivos de la familia</li>
        </ul>
