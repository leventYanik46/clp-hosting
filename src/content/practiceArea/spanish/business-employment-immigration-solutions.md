...
post:
  ...
  content: >
    ...
    <ul>
          <li>Visas de no inmigrante (H-1B, L-1, E, TN, O-1)</li>
          <li>PERM, I-140 y tarjetas de residencia basadas en empleo</li>
          <li>Políticas corporativas, I-9 y planificación de cumplimiento</li>
          <li>Planificación de movilidad para startups y equipos multinacionales</li>
        </ul>
