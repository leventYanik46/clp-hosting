...
post:
  ...
  content: >
    ...
    <ul>
          <li>Peticiones de curatela y avisos requeridos</li>
          <li>Inventario, fianza y contabilidad continua</li>
          <li>Cumplimiento judicial y comunicación con partes interesadas</li>
          <li>Estrategias para equilibrar protección con dignidad e independencia</li>
        </ul>
