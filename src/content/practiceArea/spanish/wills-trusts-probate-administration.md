...
metadata:
  ...
  description: >-
    Testamentos y fideicomisos claros respaldados por una administración
    testamentaria eficiente para honrar la voluntad y proteger a los herederos.
hero:
  tagline: Contáctenos
  title: ¡Conectemos!
  image:
...
post:
  ...
  content: >
    ...
    <p>Testamentos y fideicomisos claros respaldados por una administración
    testamentaria eficiente para honrar la voluntad y proteger a los
    herederos.</p>
    ...
    <!-- seo-expanded -->
    <h3>Por qué las familias buscan servicios legales de Testamentos, Fideicomisos y Administración Testamentaria</h3>
    ...
    <!-- seo-topoff -->
    <h3>Lo que los clientes suelen buscar en la representación de Testamentos, Fideicomisos y Administración Testamentaria</h3>
...
seo:
  title: "Testamentos, Fideicomisos y Administración Testamentaria | Servicios Legales de Capitol Law Partners"
  description: >-
    Testamentos y fideicomisos claros respaldados por una administración
    testamentaria eficiente para honrar la voluntad y proteger a los herederos.
  schema:
