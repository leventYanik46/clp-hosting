---
metadata:
  title: Litigios de Inmigración
  description: >-
    Litigios federales y administrativos para impugnar denegaciones, retrasos y
    decisiones migratorias adversas.
hero:
  tagline: Contáctenos
  title: ¡Conectemos!
  image:
...
contactForm:
  ...
  infoTitle: Litigios de Inmigración
  infoDescription: >-
    Litigios federales y administrativos para impugnar denegaciones, retrasos y
    decisiones migratorias adversas.
post:
  ...
  content: >
    ...
    <p>Litigios federales y administrativos para impugnar denegaciones, retrasos
    y decisiones migratorias adversas.</p>


    <h3>Servicios Clave</h3>

    <ul>
          <li>Acciones de mandamus por retrasos irrazonables</li>
          <li>Impugnaciones APA a denegaciones y revocaciones</li>
          <li>Apelaciones y mociones para reabrir/reconsiderar</li>
          <li>Coordinación estratégica con peticiones y exenciones subyacentes</li>
        </ul>
