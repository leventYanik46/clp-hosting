...
post:
  ...
  content: >
    ...
    <ul>
          <li>Mapas de ruta de registros y presupuestos para marcas y derechos de autor</li>
          <li>Mantenimiento, renovaciones y gestión de expedientes</li>
          <li>Licencias, cesiones y estrategias de monetización</li>
          <li>Consideraciones globales y coordinación con asesores extranjeros</li>
        </ul>
