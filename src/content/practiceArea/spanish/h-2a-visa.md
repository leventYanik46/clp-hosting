...
metadata:
  title: Visa H-2A
  description: >-
    Visas de trabajador agrícola temporal que cubren peticiones del empleador,
    cumplimiento y llegada de trabajadores.
hero:
  tagline: Contáctanos
  title: ¡Hablemos!
image:
...
contactForm:
  ...
  infoTitle: Visa H-2A
  infoDescription: >-
    Soporte integral para Visa H-2A: elegibilidad, redacción de peticiones,
...
post:
  ...
  content: >
    ...
    <p>Nuestros servicios de Visa H-2A te guían en elegibilidad, estrategia de
    ...
    de Visa H-2A, definiendo cronograma, riesgos y próximos pasos con un plan
    claro.</p>
