...
metadata:
  ...
  description: >-
    Responsabilizando a los proveedores por errores médicos prevenibles con una
    construcción de casos meticulosa.
hero:
  tagline: Contáctenos
  title: ¡Conectemos!
  image:
...
post:
  ...
  content: >
    ...
    <p>Responsabilizando a los proveedores por errores médicos prevenibles con
    una construcción de casos meticulosa.</p>


    <h3>Servicios Clave</h3>

    <ul>
          <li>Evaluación de casos con expertos médicos</li>
          <li>Análisis del estándar de atención y prueba de causalidad</li>
          <li>Negociación con aseguradoras y abogados de hospitales</li>
          <li>Preparación para juicio cuando el acuerdo no es suficiente</li>
        </ul>
