...
metadata:
  ...
  description: >-
    Defensa integral para personas en procesos de deportación, enfocada en la
    elegibilidad para alivio y la evidencia.
hero:
  tagline: Contáctenos
  title: ¡Conectemos!
  image:
...
contactForm:
  ...
  infoTitle: Defensa Contra la Deportación
  infoDescription: >-
    Defensa integral para personas en procesos de deportación, enfocada en la
    elegibilidad para alivio y la evidencia.
post:
  ...
  content: >
    ...
    <p>Defensa integral para personas en procesos de deportación, enfocada en la
    elegibilidad para alivio y la evidencia.</p>


    <h3>Servicios Clave</h3>

    <ul>
          <li>Audiencias de fianza y estrategia de custodia</li>
          <li>Solicitudes de asilo, retención y protección bajo la CAT</li>
          <li>Cancelación de deportación y exenciones</li>
          <li>Apelaciones ante la BIA y tribunales federales</li>
        </ul>
