...
metadata:
  ...
  description: >-
    Peticiones de Exención por Interés Nacional para profesionales con posgrado
    y personas de habilidad excepcional.
hero:
  tagline: Contáctanos
  title: ¡Hablemos!
image:
...
contactForm:
  ...
  infoDescription: >-
    Soporte integral para Green Card EB-2 NIW: elegibilidad, redacción de
    peticiones, pruebas y preparación para la entrevista.
  googleReview:
...
post:
  ...
  content: >
    ...
    <p>Nuestros servicios de Green Card EB-2 NIW te guían en elegibilidad,
    estrategia de petición y evidencias para mantener el caso encaminado.</p>

    <p>Coordinamos formularios, cartas de apoyo y documentación para cumplir
    estándares de USCIS y consulados, preparándote para cada etapa desde el
    envío hasta la entrevista.</p>
    ...
    <h3>Elegibilidad y Estrategia</h3> <p>Alineamos tu perfil con los criterios
    de Green Card EB-2 NIW, definiendo cronograma, riesgos y próximos pasos con
    un plan claro.</p>

    <h3>Presentación y Evidencia</h3> <p>Redactamos peticiones, reunimos
    documentación de respaldo y estructuramos anexos según las expectativas del
    evaluador.</p>

    <h3>Entrevistas y Seguimiento</h3> <p>Te preparamos para entrevistas,
    gestionamos programación y respondemos rápido a requerimientos para que el
    caso avance.</p>
