...
metadata:
  ...
  description: >-
    Registre obras creativas para asegurar la titularidad, disuadir infracciones
    y maximizar opciones de protección.
hero:
  tagline: Contáctenos
  title: ¡Conectemos!
  image:
...
contactForm:
  ...
  infoTitle: Registro de Derechos de Autor
  infoDescription: >-
    Registre obras creativas para asegurar la titularidad, disuadir infracciones
    y maximizar opciones de protección.
post:
  ...
  content: >
    ...
    <p>Registre obras creativas para asegurar la titularidad, disuadir
    infracciones y maximizar opciones de protección.</p>


    <h3>Servicios Clave</h3>

    <ul>
          <li>Registros para software, contenido, medios y diseños</li>
          <li>Documentación de trabajo por encargo y cesión de derechos</li>
          <li>Depósito de copias, tiempos y estrategia de publicación</li>
          <li>Orientación sobre uso justo, licencias y permisos</li>
        </ul>
