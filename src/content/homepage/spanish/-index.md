...
practiceAreas:
  ...
  title: Lo que ofrecemos como Capitol Law Partners
  subtitle: >-
    Ya sea que esté navegando un trámite migratorio, haciendo crecer su negocio
    o planificando su patrimonio, brindamos soluciones claras y prácticas
    basadas en sus metas personales para darle tranquilidad.
  items:
...
spotlights:
  - props:
      ...
      title: ¡Conozca a nuestros abogados en Capitol Law Partners!
    items:
      - title: Derecho Empresarial
        description: >-
          Asesoramos a startups, emprendedores y empresas en negociaciones
          contractuales, fusiones y adquisiciones, e inmigración laboral para
          garantizar una expansión global fluida y en cumplimiento.
      - title: Derecho Migratorio
        description: >-
          Ofrecemos estrategias migratorias integrales para inversionistas,
          profesionales calificados y familias. Nos enfocamos en visas E-2, L-1,
          EB-1, EB-2/NIW además de residencias por matrimonio, visas de
          prometido(a) y peticiones familiares.
      - title: Derecho de Marcas
        description: >-
          Ayudamos a empresas y propietarios de marcas con búsqueda, registro y
          estrategias de protección en EE. UU., resguardando la propiedad
    ...
    contentHtml: >-
      ...
      principales instituciones de la Ivy League en el país. Experto en asesoría
      legal estratégica en <strong>estructuración corporativa</strong>,
      <strong>transacciones comerciales</strong> y en <strong>inmigración
      laboral y familiar</strong>.
  ...
  - props:
    ...
    items:
      - title: Derecho Empresarial y Corporativo
        description: >-
          Asesora a empresas de todos los tamaños en contratos, cumplimiento,
          gestión de riesgos y privacidad para garantizar operaciones fluidas y
          estrategias legales proactivas.
      - title: Litigios
        description: >-
          Defiende a clientes en litigios civiles de alto riesgo, incluidos
          casos de lesiones personales, responsabilidad de locales y
          responsabilidad profesional, logrando resoluciones estratégicas.
      - title: Privacidad de Datos
        description: >-
          Como Certified Information Privacy Professional (CIPP/US), orienta a
          organizaciones en privacidad de datos, ciberseguridad y cumplimiento
    ...
    contentHtml: >-
      ...
      Sena Sahin es una abogada experimentada que ofrece asesoría estratégica en
      <strong>litigios civiles, consultoría corporativa y privacidad de
      datos</strong>. Licenciada en Washington D. C., Pensilvania y Texas, guía
...
testimonials:
  ...
  callToAction:
    ...
    rel: noreferrer
  items:
    - title: '"Recomiendo ampliamente trabajar con Capitol Law."'
      testimonial: >-
        Estoy muy complacido con Sena y todo el equipo. Trabajé con otro abogado
        durante 6 años y no hicieron nada. Con Sena fue muy fácil y logramos
        todo correctamente en menos de 5 meses.
      name: Edgar Mendoza
      image:
    ...
    - title: '"Más fácil y sin estrés"'
      testimonial: >-
        Estimada familia de Capitol Law, ante todo, Sr. Murat, Sr. Çağatay, Sra.
        Aynur. Mi esposa y yo queremos expresar nuestro sincero agradecimiento
        por su apoyo y guía durante nuestro proceso de visa EB2. Gracias a su
        profesionalismo, conocimiento y dedicación, completamos este proceso de
        una forma mucho más sencilla y sin estrés. Estamos agradecidos por
        acompañarnos en cada etapa y responder nuestras preguntas con paciencia.
      name: Volkan Aydıngöz
      image:
        src: ~/assets/images/testimonial-6.png
        alt: Testimonio de Volkan Aydingoz
    - title: '"El máximo profesionalismo y respeto"'
      testimonial: >-
        Recientemente tuve el placer de trabajar con Capitol Law Partners y no
        podría estar más satisfecho con sus servicios. Desde el momento en que
        entré, me trataron con el máximo profesionalismo y respeto. El equipo
        fue increíblemente conocedor, atento y meticuloso al manejar mi caso.
        Recomiendo ampliamente a Capitol Law Partners a cualquiera que busque
        servicios legales de primer nivel. ¡Gracias por su excelente trabajo!
      name: Sayed Jalal
      image:
        src: ~/assets/images/testimonial-7.png
        alt: Testimonio de Sayed Jalal
steps:
  title: Obtenga la representación legal que merece hoy
  items:
    - title: >-
        Paso 1: <span class="font-medium">Complete el formulario <a
        href="/contact" class="hover:text-primary underline font-bold">
        Contáctenos</a></span>
      description: >-
    ...
    - title: >-
        ...
        gratuita</a></span>
      description: >-
        Si su caso requiere una preevaluación más detallada, complete nuestro
    ...
    - title: >-
        ...
        consulta</a></span>
      description: >-
        Reúnase con nuestros abogados experimentados para recibir una consulta
  ...
  image:
    ...
    alt: Imagen de escalones
blog:
  title: Descubra más en nuestro blog
  information: >-
    Explore nuestro blog para obtener ideas legales, consejos prácticos y
