...
metadata:
  ...
  description: Mehmet Y. Turkoglu, immigration attorney at Capitol Law Partners, provides dedicated and strategic representation across asylum, family-based petitions, naturalization, and employment-based immigration matters.
profile:
  id: about
  columns: 2
  image:
  ...
  bio:
  - Mehmet Y. Turkoglu is an immigration attorney at Capitol Law Partners PLLC. A passionate and zealous advocate for immigrant rights, he represents clients across the full spectrum of immigration matters—including asylum, family-based petitions, naturalization, and employment-based visas—appearing regularly before USCIS and in Immigration Courts.
  - Mr. Turkoglu earned his LL.M. from the University of Minnesota Law School and holds a Bachelor of Laws degree from Istanbul University. Before focusing on immigration law in the United States, he practiced law in Turkey, gaining valuable experience in employment law as a litigation counsel.
  - Mr. Turkoglu’s commitment to human rights is reflected in his extensive involvement with The Advocates for Human Rights, where he assisted immigrants facing complex asylum and immigration challenges and contributed to human rights reports submitted to the United Nations Human Rights Council. His dedication was recognized with the organization’s 2022 Volunteer Award.
  - Leveraging his multilingual abilities and deep cross-cultural insight, Mr. Turkoglu guides clients through the complexities of the U.S. immigration system with clarity, compassion, and precision.
  actions:
...
- id: resume
  ...
  - title: University of Minnesota Law School <br /><span class="text-sm font-normal">(2020)</span>
    icon: tabler:school
  - title: Istanbul University Faculty of Law <br /><span class="text-sm font-normal">(2013)</span>
    icon: tabler:school
  classes:
    container: max-w-3xl
- id: resume
